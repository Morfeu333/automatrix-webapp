...
const agents = [
  { id: "n8n", name: "N8N Expert", emoji: "🔧", color: "bg-orange-500", description: "Workflow automation & API integrations" },
  { id: "claude", name: "Claude Assistant", emoji: "🤖", color: "bg-purple-500", description: "Code analysis & problem solving" },
  { id: "supabase", name: "Supabase Specialist", emoji: "⚡", color: "bg-green-500", description: "Database & backend services" },
  { id: "general", name: "General Agent", emoji: "🌐", color: "bg-blue-500", description: "Versatile assistance" },
]
